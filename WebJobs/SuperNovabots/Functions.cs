...
namespace SuperNovabots
{
    public class Functions
    {
        ...
        [NoAutomaticTrigger]
        public static void ManualTrigger(TextWriter log, int value, [Queue("RawSuperNovaCards")] out string rawHtmlId)
        {
            ...
            Console.WriteLine("Storing RawSuperNovaCards");
            rawHtmlId = new EventRepository<RawHtml>().Create("SuperNovaCards", rawCards).Id.ToString();
            ...
            Console.WriteLine("Triggering RawSuperNovaCards with id: " + rawHtmlId);
        }
    }
}
